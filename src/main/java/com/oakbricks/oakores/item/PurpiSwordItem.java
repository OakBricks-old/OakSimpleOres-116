...
public class PurpiSwordItem extends OaksimpleoresModElements.ModElement {
	@ObjectHolder("oaksimpleores:purpi_sword")
	public static final Item block = null;
	public PurpiSwordItem(OaksimpleoresModElements instance) {
		super(instance, 17);
	}
	...
	public void initElements() {
		...
		}, 3, -3f, new Item.Properties().group(OakoresCreativeTabItemGroup.tab)) {
		}.setRegistryName("purpi_sword"));
	}
}
