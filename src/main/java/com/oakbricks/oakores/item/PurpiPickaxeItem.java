...
public class PurpiPickaxeItem extends OaksimpleoresModElements.ModElement {
	@ObjectHolder("oaksimpleores:purpi_pickaxe")
	public static final Item block = null;
	public PurpiPickaxeItem(OaksimpleoresModElements instance) {
		super(instance, 15);
	}
