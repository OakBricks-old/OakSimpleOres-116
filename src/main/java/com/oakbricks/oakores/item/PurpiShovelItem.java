...
public class PurpiShovelItem extends OaksimpleoresModElements.ModElement {
	@ObjectHolder("oaksimpleores:purpi_shovel")
	public static final Item block = null;
	public PurpiShovelItem(OaksimpleoresModElements instance) {
		super(instance, 18);
	}
